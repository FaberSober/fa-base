...
| 业务统计          | PV / UV                | 统计页面访问量和独立访问用户                         | 当前开发 | ❌未完成  |
| 业务统计          | 业务操作统计                 | 统计关键业务事件数量                             | 当前开发 | ❌未完成  |
| 业务统计          | 模块排行                   | 统计各业务模块使用情况                            | 当前开发 | ❌未完成  |
| 业务统计          | 功能排行                   | 根据 Event Code 统计功能使用排行                 | 当前开发 | ❌未完成  |
| 业务统计          | 7 天趋势                  | 展示近期用户、业务及异常趋势                         | 当前开发 | ❌未完成  |
| 业务统计          | 30 天趋势                 | 展示中期用户、业务及异常趋势                         | 当前开发 | ❌未完成  |
| 业务统计          | 事件明细                   | 查询具体业务统计事件                             | 当前开发 | ❌未完成  |
...
| Dashboard     | 数据概览                   | 展示 DAU、登录、PV、业务操作等核心指标                 | 当前开发 | ❌未完成  |
| Dashboard     | 异常概览                   | 展示异常数量、Issue、受影响用户等指标                  | 当前开发 | ❌未完成  |
| Dashboard     | 使用趋势                   | 展示用户及业务事件趋势                            | 当前开发 | ❌未完成  |
| Dashboard     | 异常趋势                   | 展示客户端异常变化趋势                            | 当前开发 | ❌未完成  |
