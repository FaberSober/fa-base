...
SELECT 12040600, 12040000, 1, '在线客户端', 5, 1, 'mdi:cellphone-link', 1, 1,
       '/admin/system/monitor/remoteClient', CURRENT_TIMESTAMP, '1', '超级管理员', '127.0.0.1', 0
WHERE NOT EXISTS (SELECT 1 FROM `base_rbac_menu` WHERE `id` = 12040600);
